...
A robust web application built with ASP.NET Core 8, Entity Framework Core, and MySQL. This project serves as a foundation for managing users, roles, applications, and donations, and includes a powerful admin dashboard with automated schema documentation.
